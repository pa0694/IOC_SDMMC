...
#define CMD_BUZ_EXT_Pin GPIO_PIN_3
#define CMD_BUZ_EXT_GPIO_Port GPIOG
#define USB_DP_PULL_UP_Pin GPIO_PIN_12
#define USB_DP_PULL_UP_GPIO_Port GPIOC
#define SDMMC2_DETECT_Pin GPIO_PIN_3
#define SDMMC2_DETECT_GPIO_Port GPIOD
